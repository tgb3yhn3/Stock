...
public class SelfSelectedListFrame extends JFrame{

    private Map<String,ArrayList<String>> userSelfSelectedListDataMap = new HashMap<>();//記錄使用者在GUI上的自選股清單

    public SelfSelectedListFrame(MainFrame mainFrame){
        //創建頁面視窗
        super("韭菜同學會_自選股清單");
        ...
        addNewListButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                String listName = JOptionPane.showInputDialog(SelfSelectedListFrame.this,"請輸入列表名稱");
                if(listName==null){//取消輸入(按下cancel)

                }else if(listName.equals("")){//按下ok但是沒輸入任何字
                    JOptionPane.showMessageDialog(SelfSelectedListFrame.this,"列表名稱不得為空!");
                }else{//成功輸入
                    if(listNameIsRepeated(listName,userSelfSelectedListDataMap.keySet())){//不允許出現重複名稱列表
                        JOptionPane.showMessageDialog(SelfSelectedListFrame.this,"該列表名稱已經存在!");
                    }else{
                        ArrayList<String> listData = new ArrayList<>();
                        selfSelectedListComboBox.addItem(listName);
                        userSelfSelectedListDataMap.put(listName,listData);
                        JOptionPane.showMessageDialog(SelfSelectedListFrame.this,"新增列表成功");
                        saveDataToCSV();
                    }
                }
            }
        ...
        deleteListButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if(selfSelectedListComboBox.getSelectedItem()==null){
                    JOptionPane.showMessageDialog(SelfSelectedListFrame.this,"目前沒有選中列表");
                }else{
                    if(JOptionPane.showConfirmDialog(SelfSelectedListFrame.this,"是否刪除當前列表?","刪除列表",JOptionPane.YES_NO_OPTION)==0){//當選擇"yes"
                        ...
                        JOptionPane.showMessageDialog(SelfSelectedListFrame.this,"刪除列表成功!");
                        saveDataToCSV();
                    }
                }
            }
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(listName==null){
                    if(selfSelectedListComboBox.getItemCount()==0){
                        JOptionPane.showMessageDialog(SelfSelectedListFrame.this,"沒有列表存在!");
                    }else{
                        JOptionPane.showMessageDialog(SelfSelectedListFrame.this,"尚未選中列表");
                    }
                }
                else{
                    List<String> deleteStockNumS = selfSelectedList.getSelectedValuesList();//使用者選中的所有個股名稱及代號
                    if(deleteStockNumS.size() == 0){
                        JOptionPane.showMessageDialog(SelfSelectedListFrame.this,"請在自選股清單中選取要刪除的個股");
                    }
                    else{
        ...
        upDateButton.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                int choose = JOptionPane.showConfirmDialog(SelfSelectedListFrame.this,"將從資料庫讀取自選股清單，目前的資料可能會遺失，確定嗎？","更新資料",JOptionPane.YES_NO_OPTION);
                if(choose==0){
                    loadDataFromCSV(selfSelectedListComboBox,selfSelectedList);
                    JOptionPane.showMessageDialog(SelfSelectedListFrame.this,"更新資料成功!");
                }
            }
        });
        ...
        addInButton_searchStockByClass.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(listName  ==null){
                    if(selfSelectedListComboBox.getItemCount()==0){
                        JOptionPane.showMessageDialog(SelfSelectedListFrame.this,"沒有列表存在!請先新增列表");
                    }else{
                        JOptionPane.showMessageDialog(SelfSelectedListFrame.this,"尚未選中列表");
                    }
                }
                    ...
                    if(addInStockNumS.size() == 0){
                        JOptionPane.showMessageDialog(SelfSelectedListFrame.this,"尚未選中個股");
                    }
                    else{
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(listName == null){//選中列表為空(null)
                    ...
                    if(targetStockNum.equals("")){//輸入為空
                        JOptionPane.showMessageDialog(SelfSelectedListFrame.this,"請輸入欲搜尋的股票號碼");
                    }else{
                        if(targetStockNum.length()!=4){//檢查使用者輸入的股票號碼是否是四位股票號碼
                            JOptionPane.showMessageDialog(SelfSelectedListFrame.this,"找不到該個股!");
