...
public class SimulatedTradingFrame extends JFrame{
    private JTable buyAndSellTable;
    public SimulatedTradingFrame(MainFrame mainFrame, String stockNum, boolean isBuy){
        //創建到價通知頁面視窗
        super("韭菜同學會_模擬下單");
            ...
            public void actionPerformed(ActionEvent e) {
                if(!addIn_StockNumTextField.getText().equals("") && !addIn_PriceTextField.getText().equals("")&& !addIn_lotNumTextField.getText().equals("")){
                    try{
                        ...
                        JOptionPane.showMessageDialog(SimulatedTradingFrame.this,"輸入格式有誤");
                    }
                }
                else{
                    JOptionPane.showMessageDialog(SimulatedTradingFrame.this,"輸入不得為空");
                }
            }
        });
        ...
        deleteButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if(buyAndSellTable.getSelectedRow()!=-1){
                    int delete = JOptionPane.showConfirmDialog(SimulatedTradingFrame.this,"確認刪除?","", JOptionPane.YES_NO_OPTION);
                    ...
                    JOptionPane.showMessageDialog(SimulatedTradingFrame.this,"請選取您要刪除的股票(可拖曳滑鼠一次選取多筆)");
                }
            }
        });
        setVisible(true);
